        ...
        <div id="myTabContent" class="tab-content">
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    ...
                    <table id="table" class="table table-bordered table-hover" data-show-export="false" data-show-toggle="false" data-show-columns="false"
