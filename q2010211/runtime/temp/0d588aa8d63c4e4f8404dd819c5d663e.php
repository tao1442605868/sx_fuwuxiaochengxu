<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:85:"D:\phpStudy\PHPTutorial\WWW\q2010211\public/../application/admin\view\goods\edit.html";i:1604738409;s:79:"D:\phpStudy\PHPTutorial\WWW\q2010211\application\admin\view\layout\default.html";i:1603847432;s:76:"D:\phpStudy\PHPTutorial\WWW\q2010211\application\admin\view\common\meta.html";i:1603847432;s:89:"D:\phpStudy\PHPTutorial\WWW\q2010211\application\admin\view\goods\spec_many_template.html";i:1603847432;s:78:"D:\phpStudy\PHPTutorial\WWW\q2010211\application\admin\view\common\script.html";i:1603847432;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-category_id" data-rule="required" data-source="category/selectpage" data-params='{"custom[type]":"shop","isTree":1}' class="form-control selectpage form-control" name="row[category_id]" type="text" value="<?php echo $row['category_id']; ?>">
        </div>
    </div>
<!--    <div class="form-group">-->
<!--        <label class="control-label col-xs-12 col-sm-2"><?php echo __('品牌'); ?>:</label>-->
<!--        <div class="col-xs-12 col-sm-8">-->
<!--            <input id="c-brand_id" data-rule="required" data-source="mall/brand/selectpage"  class="form-control selectpage form-control" name="row[brand_id]" type="text" value="<?php echo $row['brand_id']; ?>">-->
<!--        </div>-->
<!--    </div>-->
<!--    <div class="form-group">-->
<!--        <label class="control-label col-xs-12 col-sm-2">补贴金额:</label>-->
<!--        <div class="col-xs-12 col-sm-8">-->
<!--            <input id="c-subsidy_price" data-rule="required" class="form-control form-control" name="row[subsidy_price]" type="number" value="<?php echo $row['subsidy_price']; ?>">-->
<!--        </div>-->
<!--    </div>-->
    <div class="form-group">
        <label for="c-goods_desc" class="control-label col-xs-12 col-sm-2"><?php echo __('商品描述'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-goods_desc" class="form-control" name="row[goods_desc]"><?php echo htmlentities($row['goods_desc']); ?></textarea>
        </div>
    </div>
    <div class="form-group">
        <label for="c-goods_notes" class="control-label col-xs-12 col-sm-2"><?php echo __('购买须知'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-goods_notes" class="form-control" name="row[goods_notes]"><?php echo htmlentities($row['goods_notes']); ?></textarea>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-image" data-rule="required" class="form-control form-control" size="50" name="row[image]" type="text" value="<?php echo $row['image']; ?>">
    ...
    <div class="goods-spec-single">
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-8">
                <input id="c-yuan_price" data-rule="required" class="form-control form-control" name="spec[yuan_price]" type="number" value="<?php echo $row['yuan_price']; ?>">
            </div>
        </div>
    </div>
    <div class="form-group">
