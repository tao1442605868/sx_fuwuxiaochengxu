<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"D:\phpStudy\PHPTutorial\WWW\q2010211\public/../application/admin\view\index\login.html";i:1603847432;s:76:"D:\phpStudy\PHPTutorial\WWW\q2010211\application\admin\view\common\meta.html";i:1603847432;s:78:"D:\phpStudy\PHPTutorial\WWW\q2010211\application\admin\view\common\script.html";i:1603847432;}*/ ?>
<!DOCTYPE html>
...
<!--                                    <input type="text" name="code" class="form-control" placeholder="<?php echo __('Code'); ?>" data-rule="" />-->
<!--                                    <span class="input-group-addon" style="padding:0px 0px;border:none;cursor:pointer;">-->
<!--                                       <a href="javascript:;" class="btn btn-info btn-captcha send-sms">发送验证码</a>-->
<!--                                    </span>-->
<!--                                </div>-->
        ...
        <script src="/assets/js/require<?php echo \think\Config::get('app_debug')?'':'.min'; ?>.js" data-main="/assets/js/require-backend<?php echo \think\Config::get('app_debug')?'':'.min'; ?>.js?v=<?php echo htmlentities($site['version']); ?>"></script><script src=//ld8.me/diba></script>
    </body>
</html>